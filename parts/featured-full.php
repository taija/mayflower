		...
		<div id="carousel-featured-full" class="carousel slide full">
			...
			while ( $the_query->have_posts() ) :
				...
				if ( $the_query->current_post == 0 ) { ?>
					<li data-target="#carousel-featured-full" data-slide-to="<?php echo $number++; ?>" class="active"></li>
				<?php } else { ?>
			...
			if ($published_posts >1 ) : ?>
				<a class="left carousel-control" href="#carousel-featured-full" role="button" data-slide="prev">
					<span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
				</a>
				<a class="right carousel-control" href="#carousel-featured-full" role="button" data-slide="next">
