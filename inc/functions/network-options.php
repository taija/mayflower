 ...
 *
 * @global	array	$mayflower_network_options	holds Theme options
 */
global $mayflower_network_network_options;
 ...
 */
function mayflower_network_register_options(){
	require( get_template_directory() . '/inc/functions/network-options-register.php' );
}
// Settings API options initilization and validation
add_action( 'admin_init', 'mayflower_network_register_options' );
 ...
 *
 * @uses	mayflower_network_get_settings_page_cap()	defined in \functions\wordpress-hooks.php
 */
function mayflower_network_add_theme_page() {
	// Globalize Theme options page
	global $mayflower_network_settings_page;
	// Add Theme options page
	$mayflower_network_settings_page = add_theme_page(
		// $page_title
		...
		mayflower_network_get_settings_page_cap(),
		// $menu_slug
		// String to append to URL after "themes.php"
		'mayflower-settings',
		// $callback
		// Function to define settings page markup
		'mayflower_network_admin_options_page'
	);
}
// Load the Admin Options page
add_action( 'network_admin_menu', 'mayflower_network_add_theme_page' );

/**
 * Mayflower Theme Settings Page Markup
 *
 * @uses	mayflower_network_get_current_tab()	defined in \functions\custom.php
 * @uses	mayflower_network_get_page_tab_markup()	defined in \functions\custom.php
 */
function mayflower_network_admin_options_page() {
	// Determine the current page tab
	$currenttab = mayflower_get_current_tab();
	// Define the page section accordingly
	$settings_section = 'mayflower_network_' . $currenttab . '_tab';
	?>
	...
	<div class="wrap">
		...
		<?php
			...
			settings_fields('theme_mayflower_network_options');
			// Output each settings section, and each
			// Settings field in each section
			do_settings_sections( $settings_section );
		?>
			<?php submit_button( __( 'Save Settings', 'mayflower' ), 'primary', 'theme_mayflower_network_options[submit-' . $currenttab . ']', false ); ?>
			<?php submit_button( __( 'Reset Defaults', 'mayflower' ), 'secondary', 'theme_mayflower_network_options[reset-' . $currenttab . ']', false ); ?>
		</form>
	</div>
<?php
}
 ...
 * options.
 *
 * @uses	mayflower_network_get_option_parameters()	defined in \functions\options.php
 *
 * @return	array	$defaults	associative array of option defaults
 */
function mayflower_network_get_option_defaults() {
	// Get the array that holds all
	// Theme option parameters
	$option_parameters = mayflower_network_get_option_parameters();
	...
	return apply_filters( 'mayflower_network_option_defaults', $option_defaults );
}

/**
 * Define default options tab
 */
function mayflower_network_define_default_options_tab( $options ) {
	$options['default_options_tab'] = 'general';
	return $options;
}
add_filter( 'mayflower_network_option_defaults', 'mayflower_network_define_default_options_tab' );
 ...
 */
function mayflower_network_get_option_parameters() {

    $options = array(
        'mayflower_network_version' => array(
			'name' => 'mayflower_network_version',
...
/*		'show_on_front' => array (
			...
			'title' => '',
			'type' => 'custom',
			'description' => mayflower_network_show_on_front(),
...
*/
    ...
    return apply_filters( 'mayflower_network_get_option_parameters', $options );
}
 ...
 * used instead.
 *
 * @uses	mayflower_network_get_option_defaults()	defined in \functions\options.php
 *
 * @uses	get_option()
 * @uses	wp_parse_args()
 *
 * @return	array	$mayflower_network_options	current values for all Theme options
 */
function mayflower_network_get_options() {
	// Get the option defaults
	$option_defaults = mayflower_network_get_option_defaults();
	// Globalize the variable that holds the Theme options
	global $mayflower_network_options;
	// Parse the stored options with the defaults
	$mayflower_network_options = wp_parse_args( get_option( 'theme_mayflower_network_options', array() ), $option_defaults );
	// Return the parsed array
	return $mayflower_network_options;
}
 ...
 *
 * @uses	mayflower_network_get_option_parameters()	defined in \functions\options.php
 * @uses	mayflower_network_get_settings_page_tabs()	defined in \functions\options.php
 *
 * @return	array	$settingsbytab	array of arrays of settings by tab
 */
function mayflower_network_get_settings_by_tab() {
	// Get the list of settings page tabs
	$tabs = mayflower_network_get_settings_page_tabs();
 ...
 * description text.
 *
 * @uses	mayflower_network_get_skin_text()	defined in \functions\options-register.php
 *
 * @return	array	$tabs	array of arrays of tab parameters
 */
function mayflower_network_get_settings_page_tabs() {
			...
			'sections' => array(
				...
				*/
				...
				'skin' => array(
					'name' => 'skin',
					'title' => __( 'Color Scheme', 'mayflower' ),
					'description' => mayflower_network_get_skin_text()
				),
				*/
...
//					'description' => mayflower_network_get_homepage_text()
//				),
	...
	return apply_filters( 'mayflower_network_get_settings_page_tabs', $tabs );
}
