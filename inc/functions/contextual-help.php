 ...
 *
 * This callback is hooked into the load-$mayflower_settings_page hook,
 * via the mayflower_add_theme_page() callback, which is hooked into the
 * admin_menu hook. The mayflower_add_theme_page() callback is defined
...
function mayflower_settings_page_contextual_help() {
	...
	$screen->add_help_tab( array(
		...
		// Tab Title
		'title'   => __( 'Settings - Varietals', 'mayflower' ),
		// Tab content
	...
	$screen->add_help_tab( array(
		...
		// Tab title
		'title'   => __( 'Settings - Layout', 'mayflower' ),
		// Tab content
	...
	$screen->add_help_tab( array(
		...
		// Tab Title
		'title'   => __( 'Settings - General', 'mayflower' ),
		// Tab content
	...
	$screen->add_help_tab( array(
		...
		// Tab title
		'title'   => __( 'Theme Features', 'mayflower' ),
		// Tab content
	...
	$screen->add_help_tab( array(
		...
		'id'      => 'oenology-coderef',
		// Tab title
		'title'   => __( 'Code Reference', 'mayflower' ),
		// Tab content
	...
	$screen->add_help_tab( array(
		...
		'id'      => 'oenology-support',
		// Tab title
		'title'   => __( 'Theme Support', 'mayflower' ),
		// Tab content
