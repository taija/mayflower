 ...
 */
/*
function mayflower_set_content_width() {
	global $pagenow;
...
// Hook mayflower_set_content_width() into 'admin_head'
add_action( 'admin_head', 'mayflower_set_content_width' );
// Hook mayflower_set_content_width() into 'wp_head'
add_action( 'wp_head', 'mayflower_set_content_width', 0 );
...
function mayflower_setup() {
	 ...
	 * @since	WordPress 3.0.0
	 */
	//add_custom_image_header( 'mayflower_header_style', 'mayflower_admin_header_style' );
/*
	add_theme_support( 'custom-header', array(
		...
		'default-text-color'	=> mayflower_get_header_textcolor(),
		// Header image width (in pixels)
		'width'					=> apply_filters( 'mayflower_header_image_width', 1000 ),
		// Header image height (in pixels)
		'height'				=> apply_filters( 'mayflower_header_image_height', 198 ),
		// Header image random rotation default
		'random-default'		=> false,
		// Template header style callback
		'wp-head-callback'		=> 'mayflower_header_style',
		// Admin header style callback
		'admin-head-callback'	=> 'mayflower_admin_header_style'
	) );
*/
	 ...
	 * mayflower_get_post_formats().
	 *
	 * Child Themes can change the array of supported
	 * post formats via the 'mayflower_supported_post_formats'
...
/*
	...
	$postformats = mayflower_get_post_formats();
	$supportedpostformats = array();
	foreach ( $postformats as $format ) {
		$supportedpostformats[] = $format['slug'];
	}
	$supportedpostformats = apply_filters( 'mayflower_supported_post_formats', $supportedpostformats );
...
*/
	...
	// custom headers. See mayflower_admin_header_style(), below.
 ...
 */
function mayflower_header_style() {
?>
<style type="text/css">
...
#site-header-text {
	...
	if ( 'above' == $mayflower_options['header_nav_menu_position'] ) {
		if ( get_header_image() ) {
			?>
#nav,
.navmenu,
 ...
 * definitions for the custom image header.
 */
function mayflower_admin_header_style() {
?>
<style type="text/css">
#headimg {
